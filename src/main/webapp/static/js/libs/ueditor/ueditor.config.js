...
(function () {
    ...
    var ubasePath = localhostPath;
    
    if ('/admin' == projectName) projectName = '';
    ubasePath += projectName + "/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imagePath:basePath+"static"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imagePath:imgCdn                      //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,catcherPath:imgCdn       //图片修正地址，同imagePath
        ...
        ,imageManagerPath:imgCdn          //图片修正地址，同imagePath
		...
		['source', '|', 'undo', 'redo', '|',
		 ...
		 'rowspacingtop', 'rowspacingbottom', 'lineheight', '|','link', 'unlink', 'anchor','|', 
		 'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
		 'directionalityltr', 'directionalityrtl', 'indent', '|',
		 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|',
		 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
		 'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'map', 'gmap', 'insertframe', 'webapp', 'pagebreak', 'template', 'background', '|',
